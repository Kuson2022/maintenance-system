...
export function QrCodeDisplay({ qrCode, equipmentName, equipmentCode }: QrCodeDisplayProps) {
    ...
    useEffect(() => {
        async function generateQr() {
            try {
                const result = await generateQrCodeImageAction(qrCode);
